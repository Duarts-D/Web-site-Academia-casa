...
from .models import Dias,Videos,TreinoDiaPadrao,CategoriaModel,OrdemLista,EquipamentoModel,TreinoDiaUser
...
class TreinoDiaUserAdmin(admin.ModelAdmin):
    list_display = ('user',)
...
admin.site.register(TreinoDiaUser,TreinoDiaUserAdmin)
